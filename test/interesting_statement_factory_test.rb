...
class InterestingStatementFactoryTest < MiniTest::Unit::TestCase
  ...
  def test_build_investments
    ...
    stmt_stub1 = StatementStub.new(fund_names, [99.2, 25.6, 100], Date.new(2011, 2, 1), [1.1, 2.2, 3.3])
    stmt_stub2 = StatementStub.new(fund_names, [12.2, 4.6, 100], Date.new(2011, 2, 2), [1.4, 2.4, 3.8])
